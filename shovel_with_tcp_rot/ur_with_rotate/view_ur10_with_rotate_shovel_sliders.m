function robot = view_ur10_with_rotate_shovel_sliders()
%VIEW_UR10_WITH_ROTATE_SHOVEL_SLIDERS Display UR10 + shovel with joint sliders.

scriptDir = fileparts(mfilename("fullpath"));
urdfFile = "ur10_with_rotate_shovel.urdf";
...
fig = figure("Name", "UR10 + rotating shovel joint sliders", "Color", "w");
ax = axes("Parent", fig, "Position", [0.08 0.32 0.88 0.63]);
sliderPanel = uipanel( ...
    "Parent", fig, ...
    "Units", "normalized", ...
    "Position", [0.04 0.03 0.92 0.24], ...
    "BorderType", "none", ...
    "BackgroundColor", "w");
...
buildJointSliders();
    ...
    function drawRobot()
        ...
        grid(ax, "on");
        view(ax, 135, 20);
        title(ax, "ur10\_with\_rotate\_shovel");
        drawnow limitrate;
    end
end
